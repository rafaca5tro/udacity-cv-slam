...
class robot:
    ...
    def sense(self):
        ''' Measures the distance between the robot and any landmarks within
            its measurement range. Returns a list of [landmark_index, dx, dy]
            measurements, accounting for measurement noise.
            '''
        measurements = []
